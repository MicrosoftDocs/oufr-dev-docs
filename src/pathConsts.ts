...
if (!path.isAbsolute(docsOutputPath) && !path.isAbsolute(documenterInputFilesPath) && env !== 'local') {
...
export const inputFilesPath: string = path.resolve(documenterInputFilesPath);
